...
export default function FilterOptions( { type, close, isVisible, addFilter, removeFilter, reset }: FilterOptions) {
  const hours = ["Flexible (Between 1 and 10)", "Flexible (Between 10 and 20)", "Part-time (< 38)", "Full-time (38)", "Open source"];
  const tags = ["Coding", "Maths", "Arts", "Science", "Health", "Business", "Javascript", "UI/UX", "Python", "UI/UX"];
    ...
    >
      ...
      <View className="absolute bottom-0 w-full bg-background rounded-2xl p-4">
        ...
        <View className="items-center mb-8 mt-4">
          <FilledButton title="Apply" textStyle="text-xl" onPress={() => {
            close();
            addFilter();
          }} />
          <FilledButton 
