            ...
            <View className="w-full items-center">
              ...
              <View className="flex-col gap-4 mt-4 pb-28 w-[85%]">
                ...
                <Text className="pt-5 text-xl text-white">
                  This app is designed to help students coordinate meal plans,
                  form dining groups, and discover the best on-campus dining
                  spots. Whether students are looking for a quick meal between
                  classes or a chance to socialise over lunch, this app provides
                  a seamless experience for organising group meals on campus.
                </Text>
                ...
                <Text className="pb-5 text-xl text-gray-400">
                  As the user base grows, we’ve added new features to our
                  community forums: the ability to create private groups, share
                  photos, and...
