import { Text, Image, View, SafeAreaView, TextInput, TouchableOpacity, TouchableWithoutFeedback, Keyboard} from "react-native";
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View className="flex-1 bg-[#171F20]">
        <SafeAreaView className="w-full items-center">
          ...
          <Link href="/forgotPassword" className="text-white text-lg underline my-2">Forgot password?</Link>
